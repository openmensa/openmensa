...
if OMNI_CONFIG
  Rails.application.config.middleware.use OmniAuth::Builder do
    ...
    if OMNI_CONFIG['twitter']
      provider :twitter, OMNI_CONFIG['twitter']['key'], OMNI_CONFIG['twitter']['secret']
    end
    if OMNI_CONFIG['facebook']
      provider :facebook, OMNI_CONFIG['facebook']['key'], OMNI_CONFIG['facebook']['secret']
    end
